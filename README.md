...
## 🚀 Overview
Educational simulation game designed for prevention training, featuring interactive scenarios and user feedback loops.
...
## 🛠️ Technology Stack
*   **Core**: Simulation, Game Design, Education
*   **Infrastructure**: Git, Local Environment

## 📦 Installation & Setup
```bash
# Clone the repository
git clone https://github.com/rodrigope12/prevencion_pug.git
